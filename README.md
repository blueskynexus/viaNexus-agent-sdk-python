...
```bash
uv add git+https://github.com/blueskynexus/viaNexus-agent-sdk-python --tag v1.0.0-pre11
```

Or with `pip`:

```bash
pip install git+https://github.com/blueskynexus/viaNexus-agent-sdk-python@v1.0.0-pre11
```
