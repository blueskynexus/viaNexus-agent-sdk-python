#!/usr/bin/env python3
"""
Gemini Client Memory Integration Example
...
async def memory_integration_example():
    ...
    try:
        print("🧠 Gemini Client Memory Integration Example")
        print("=" * 50)
        
        # Example 1: In-Memory Storage (default)
        print("\n1️⃣ In-Memory Storage Example:")
        client_memory = GeminiClient.with_in_memory_store(config, user_id="user_123")
        ...
        client_file = GeminiClient.with_file_memory_store(
            config, 
        ...
        client_reload = GeminiClient.with_file_memory_store(
            config,
            storage_path=temp_dir,
            user_id="user_123",
        ...
        client_stateless = GeminiClient.without_memory(config)
